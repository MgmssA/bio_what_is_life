...
Die Stoffe, die wir aus der Nahrung extrahieren heißen **Nährstoffe**. Die **essentiellen** Nährstoffe; das sind diejenigen Nährstoffe, die unser Körper nicht selbst synthetisieren kann. Der Begriff *Nährstoff* ist jedoch etwas ungenau. Zum Beispiel gelten einige Ionen^[Ionen sind positive geladene Atomkerne. In biologischen Systemen liegen Ionen immer in wässriger Phase vor. Zum Beispiel würde das zweifach positive geladene Magnesium als $\ce{Mg^2+ (aq)}$ geschrieben werden.] als Makronährstoffe und Mikronährstoffe, obwohl sie nicht durch den Stoffwechsel verändern sondern nur teilnehmen.
...
Die Art und Weise wie die genetische Information gespeichert und weitergegeben wird, steht nach neuestem Erkenntnissen am Anfang des Lebens auf unserem Planeten. Die genetische Information wird in unglaublich lange lineare Moleküle kodiert^[Zum Beipiel ist die Gesamtlänge der männlichen menschlichen DNA 2.05 m; bei Frauen erreicht sie über 2.08 m. Trotz dieser beachtlichen Länge, wird die Information innerhalb eines mikroslopischen Bereichs komprimiert.], die aus DNA^[**D**esoxyribo**n**ucleic **a**cid ist das englische Wort für die Desoxyribonukleinsäure, oder DNS auf deutsch.] bestehen. In Bakterien befindet sie sich lose innerhalb der Zelle; bei höheren Organismen liegt die DNA in einer hochkompimierten Form in einem Zellkern vor. 
