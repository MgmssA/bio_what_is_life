...
%%| fig-cap: Der katabole Pfad oben zerkleinert ddas Pizzastück, um daraus die Bausteine für den anabolen Pfad des Knochenbaus zu gewinnen. Das ist jedoch nur dann möglich, wenn der katabole Würfelzuckerabbau die notwendige Energie $E$ für den anabolen Knochenbau bereitstellt. 
flowchart LR
